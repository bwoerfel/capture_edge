...
static inline void ws2812_program_init(PIO pio, uint sm, uint offset, uint neopixel_data_io, uint neopixel_power_io, float freq, bool rgbw) {
    pio_gpio_init(pio, neopixel_data_io);
    pio_sm_set_consecutive_pindirs(pio, sm, neopixel_data_io, 1, true);
    gpio_init(neopixel_power_io);
    gpio_set_dir(neopixel_power_io, GPIO_OUT);
    gpio_put(neopixel_power_io, 1);
    pio_sm_config c = ws2812_program_get_default_config(offset);
    sm_config_set_sideset_pins(&c, neopixel_data_io);
